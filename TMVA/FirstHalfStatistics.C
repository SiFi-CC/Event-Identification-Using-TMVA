...
using namespace std;
/// To use Cross-Validation training, user should define a useful variable called "EventID"
/// to be used as a suitable spectator when dividing data sample into different k-folds.
/// This macro is used to do so.

void FirstHalfStatistics() {
    
    
    TString outfileName( "PMMA180MeV0mmBPType3_EnoughStatistics_EI-s2s3s4s5FirsthalfModified2sigma.root" );
    ...
    Float_t PosX_abs, PosY_abs, PosZ_abs, Energy_abs, EnDiff;
...
///////////////////////////////////////////////////////////////////////    
    ...
    fTreeSB->SetCircular(2000000); 
      ...
      // load the input file
    TFile *input(0);
    TString fname = "./PMMA180MeV0mmBPType3_EnoughStatistics_EI-s2s3s4s5-half-sigma2.root";
    ...
    fTree_stat->Branch("StartEvent", &istart); 
    fTree_stat->Branch("StopEvent", &istop); 
    fTree_stat->Branch("TotalSimNev", &totalsimnev); 
